...
| Education IT / innovation software architect | Full-stack product architecture, cloud-native service boundaries, REST APIs, DevOps practices, LLM/lakehouse awareness, and architecture documentation | [`../../frontend/README.md`](../../frontend/README.md), [`../../backend/README.md`](../../backend/README.md), [`SYSTEM_OVERVIEW.md`](SYSTEM_OVERVIEW.md) |
| AI engineer / GenAI platform engineer | RAG, embeddings, prompt contracts, provider abstraction, audit logging, degraded states, and clear extension seams for agents/evals | [`../../backend/app/api/chat.py`](../../backend/app/api/chat.py), [`../../backend/app/llm/`](../../backend/app/llm/), [`../../backend/app/embeddings/`](../../backend/app/embeddings/), [`DESIGN_NOTES.md`](DESIGN_NOTES.md) |
| Data science / analytics director | Structured and unstructured data thinking, reproducible corpus construction, predictive/ML-adjacent architecture, stakeholder-readable documentation | [`../guides/CORPUS_ARTIFACTS.md`](../guides/CORPUS_ARTIFACTS.md), [`../../data_prep/README.md`](../../data_prep/README.md), [`PORTFOLIO_CASE_STUDY.md`](PORTFOLIO_CASE_STUDY.md) |
...
|---|---|
| Grounded RAG over clinical notes | [`backend/app/api/chat.py`](../../backend/app/api/chat.py) retrieves note embeddings, builds citation-shaped prompt blocks, and returns citations. |
| AI audit is first-class data | [`backend/alembic/versions/20260505_003_ai_interactions.py`](../../backend/alembic/versions/20260505_003_ai_interactions.py) creates `ai_interactions`; [`backend/app/responsible_ai/`](../../backend/app/responsible_ai/) handles hashes, redaction, source traces, and safety heuristics. |
| Provider boundaries are configurable | [`backend/app/config.py`](../../backend/app/config.py), [`backend/app/llm/`](../../backend/app/llm/), and [`backend/app/embeddings/`](../../backend/app/embeddings/) separate Groq, Azure OpenAI, OpenAI embeddings, and Amazon Bedrock postures. |
| Corpus build is a data product, not a fixture | [`data_prep/README.md`](../../data_prep/README.md) and [`docs/guides/CORPUS_ARTIFACTS.md`](../guides/CORPUS_ARTIFACTS.md) document the offline Synthea + public-note pipeline, validation, manifest, dataset card, and audit report. |
| Product UX is workflow-shaped | [`frontend/src/app/patients/`](../../frontend/src/app/patients/), [`frontend/src/app/chat/`](../../frontend/src/app/chat/), and screenshots in [`docs/assets/showcase/readme/`](../assets/showcase/readme/) show chart review, encounter viewing, meeting prep, note generation, and audit review. |
...
4. Inspect [`backend/app/api/chat.py`](../../backend/app/api/chat.py), [`backend/app/api/patients.py`](../../backend/app/api/patients.py), and [`backend/app/responsible_ai/`](../../backend/app/responsible_ai/) for the AI workflow implementation.
5. Inspect [`data_prep/README.md`](../../data_prep/README.md) if the review is about data engineering, reproducibility, or analytics/data-science platform judgment.
