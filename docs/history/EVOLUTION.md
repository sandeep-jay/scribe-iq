...
- Established the overview layer as the **portfolio narrative** entrypoint. Added [`docs/overview/PORTFOLIO_CASE_STUDY.md`](../overview/PORTFOLIO_CASE_STUDY.md) (recruiter / hiring-manager case study with higher-ed to healthcare bridge, intentionally-not-production list, and extension plan) and [`docs/overview/RESUME_SNIPPETS.md`](../overview/RESUME_SNIPPETS.md) (generic, healthcare/UCLA-targeted, and LinkedIn-length descriptions).
...
- Extended [`docs/overview/PRIVACY_AND_PROVIDER_BOUNDARIES.md`](../overview/PRIVACY_AND_PROVIDER_BOUNDARIES.md) with a provider-modes table (demo / Azure / AWS / mixed), an embedding-provider caveat, and a portfolio-interpretation section.
